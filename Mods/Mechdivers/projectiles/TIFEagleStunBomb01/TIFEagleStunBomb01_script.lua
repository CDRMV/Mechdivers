...
TIFEagleStunBomb01 = Class(TNapalmCarpetBombProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('UEFSSP0200s', self:GetArmy(), location[1], location[2], location[3], 0, 0, 0)
		SetIgnoreArmyUnitCap(self:GetArmy(), false)
		TNapalmCarpetBombProjectile.OnImpact( self, TargetType, targetEntity )
    end,
}

TypeClass = TIFEagleStunBomb01
