...
TDFAntiTankMine2 = Class(TDFMineProjectile) {
	...
	OnImpact = function(self, TargetType, targetEntity)
		...
		local ShieldUnit =CreateUnitHPR('UEBMD002', self:GetArmy(), position[1], position[2], position[3], 0, 0, 0)
		SetIgnoreArmyUnitCap(self:GetArmy(), false)
		end
		TDFMineProjectile.OnImpact( self, TargetType, targetEntity )
	end,
}
TypeClass = TDFAntiTankMine2
