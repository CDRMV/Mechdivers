...
TIFMissileNuke01 = Class(TIFMissileNuke) {
    ...
    BeamName = '/mods/Mechdivers/effects/emitters/missile_exhaust_fire_beam_07_emit.bp',
	...
	OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
			...
			DamageArea(self, self:GetPosition(), 10, 25, 'Force', true, true)
    ...
    MovementThread = function(self)
        ...
        local launcher = self:GetLauncher()
        self.CreateEffects( self, self.InitialEffects, army, 0.2 )
