...
Blu3000EffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        self:CreateProjectile('/mods/Mechdivers/effects/entities/Blu3000/Blu3000Effect02/Blu3000Effect02_proj.bp',0,PlumeEffectYOffset,0,0,0,1)        
    ...
    CreateInitialFireballSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            self:CreateProjectile('/mods/Mechdivers/effects/entities/Blu3000/Blu3000EffectShockwave01/Blu3000EffectShockwave01_proj.bp', X * OffsetMod , 1.5, Z * OffsetMod, X, 0, Z)
    ...
    CreateOuterRingWaveSmokeRing = function(self)
        ...
        for i = 0, (sides-1) do
            local X = math.sin(i*angle)
            local Z = math.cos(i*angle)
            local proj =  self:CreateProjectile('/mods/Mechdivers/effects/entities/Blu3000/Blu3000EffectShockwave02/Blu3000EffectShockwave02_proj.bp', X * OffsetMod , 2.5, Z * OffsetMod, X, 0, Z)
    ...
    CreateFlavorPlumes = function(self)
        ...
        for i = 0, (numProjectiles -1) do
            ...
            table.insert(projectiles, self:CreateProjectile('/mods/Mechdivers/effects/entities/Blu3000/Blu3000EffectFlavorPlume01/Blu3000EffectFlavorPlume01_proj.bp', 0, 0, 0, xVec, yVec, zVec):SetVelocity(velocity) )
        end
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/Mechdivers/effects/entities/Blu3000/Blu3000Effect03/Blu3000Effect03_proj.bp', x, HeightOffset, z, x, 0, z)
                :SetVelocity(velocity)
            table.insert(projectiles, proj)
        end   
    ...
    do
        ...
        self:CreateProjectile('/mods/Mechdivers/effects/entities/Blu3000/Blu3000Effect05/Blu3000Effect05_proj.bp', x, RandomFloat(outer_lower_height, outer_upper_height), z, x, 0, z)
