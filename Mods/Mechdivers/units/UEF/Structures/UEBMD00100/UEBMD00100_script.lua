...
UEBMD00100 = Class(TAirFactoryUnit) {
	...
	OnStopBeingBuilt = function(self,builder,layer)
		...
		self.Beacon = CreateUnitHPR('UEBMD0101', self:GetArmy(), position[1], position[2], position[3], 0, 0, 0)
		self.Beacon:AttachBoneTo(-2, self, 'Pod')
