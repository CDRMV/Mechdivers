...
R_AntiTankCannon = Class(DummyUnit) {
    ...
    Weapons = {
		...
		self.unit.Animator:PlayAnim('/Mods/Mechdivers/units/UEF/Modules/Right Arm/R_AntiTankCannon/R_AntiTankCannon_Reload.sca', false):SetRate(-1)
