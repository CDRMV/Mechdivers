...
CSKMDTL0200 = Class(TWalkingLandUnit) {
	...
	OnScriptBitSet = function(self, bit)
		...
		self:SetWeaponEnabledByLabel('L_Flamethrower', false)
		self:SetWeaponEnabledByLabel('R_Flamethrower', false)
		self.fold = true
		elseif bit == 7 then
		...
		local position = self.Beacon:GetPosition()
			...
			self:SetWeaponEnabledByLabel('L_Flamethrower', true)
			self:SetWeaponEnabledByLabel('R_Flamethrower', true)
