...
CSKMDCL0309 = Class(CWalkingLandUnit) {
    Weapons = {
		...
		OnWeaponFired = function(self)
			...
			if number == 1 then
            animator:PlayAnim('/Mods/Mechdivers/units/Cybran/CSKMDCL0309/CSKMDCL0309_ASaw01.sca', false):SetRate(2)
			else
			animator:PlayAnim('/Mods/Mechdivers/units/Cybran/CSKMDCL0309/CSKMDCL0309_ASaw02.sca', false):SetRate(2)
			end
			WaitFor(animator)
			animator:Destroy()
			end)
