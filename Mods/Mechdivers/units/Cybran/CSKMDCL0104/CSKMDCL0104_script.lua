...
CSKMDCL0104 = Class(CWalkingLandUnit) {
    Weapons = {
	...
	OnCreate = function(self)
		...
		RifleMesh = '/mods/Mechdivers/Decorations/CybranBot_Launcher_mesh'
		self.Rifle = import('/lua/sim/Entity.lua').Entity()
        self.Rifle:AttachBoneTo( -1, self, 'Rocket_Launcher' )
