...
UEFSSP0200z = Class(StructureUnit) {
    Weapons = {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        StructureUnit.OnStopBeingBuilt(self,builder,layer)
			...
			self.Effect1 = CreateAttachedEmitter(self,0,self:GetArmy(), Effectpath .. 'miasma_cloud_01_emit.bp'):ScaleEmitter(2.0):SetEmitterParam('LIFETIME', -1)
			self.Effect2 = CreateAttachedEmitter(self,0,self:GetArmy(), Effectpath .. 'miasma_cloud_01_emit.bp'):ScaleEmitter(2.0):SetEmitterParam('LIFETIME', -1)
				local interval = 0
