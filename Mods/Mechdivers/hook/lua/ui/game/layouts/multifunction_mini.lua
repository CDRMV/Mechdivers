...
function SetLayout()
    local controls = import("/mods/Mechdivers/hook/lua/ui/game/multifunction.lua").controls
    local savedParent = import("/mods/Mechdivers/hook/lua/ui/game/multifunction.lua").savedParent
