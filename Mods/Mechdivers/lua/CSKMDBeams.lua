...
TronCollisionBeam = Class(CollisionBeam) {
    ...
    FxBeam = {
		'/mods/Mechdivers/effects/emitters/tron_beam_01_emit.bp'
	},
    FxBeamEndPoint = {
		--'/mods/Mechdivers/effects/emitters/tron_beam_end_01_emit.bp',
		'/mods/Mechdivers/effects/emitters/tron_beam_end_02_emit.bp',
		'/mods/Mechdivers/effects/emitters/tron_beam_end_03_emit.bp',
		--'/mods/Mechdivers/effects/emitters/tron_beam_end_04_emit.bp',
		--'/mods/Mechdivers/effects/emitters/tron_beam_end_05_emit.bp',
		'/mods/Mechdivers/effects/emitters/tron_beam_end_06_emit.bp',
	},
