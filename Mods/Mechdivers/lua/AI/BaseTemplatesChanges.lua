function ChangeBaseTemplate(group)
    local BaseTemplates = {
        ...
        ChallengeExpansion = {Builders = {'AdvancedLightBotFactorySupport', 'AdvancedHeavyFactorySupport', 'LandingpadSupport', 'T1AdvancedLightBotFactoryBuilders', 'T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2,}}},
        ChallengeMain = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
        ...
        ChallengeNaval = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders', 'T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        NavalExpansionLarge = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        NavalExpansionSmall = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        ...
        RushExpansionAirFull = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        RushExpansionAirSmall = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        RushExpansionBalancedFull = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        RushExpansionBalancedSmall = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        RushExpansionLandFull = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        RushExpansionLandSmall = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        RushExpansionNaval = {Builders = {'AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 0, AdvancedHeavyFactory = 0, Landingpad = 0}}},
        RushMainAir = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
        ...
        TechExpansion = {Builders = {'AdvancedLightBotFactorySupport', 'LandingpadSupport','T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 3, AdvancedHeavyFactory = 3, Landingpad = 2}}},
        TechExpansionSmall = {Builders = {'AdvancedLightBotFactorySupport', 'LandingpadSupport','T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 2, AdvancedHeavyFactory = 2, Landingpad = 1}}},
        TechMain = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
        ...
        TurtleExpansion = {Builders = {'AdvancedLightBotFactorySupport', 'LandingpadSupport','T1AdvancedLightBotFactoryBuilders','T2AdvancedHeavyFactoryBuilders',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 1, Landingpad = 1}}},
        TurtleMain = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
