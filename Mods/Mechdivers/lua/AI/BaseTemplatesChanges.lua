function ChangeBaseTemplate(group)
    local BaseTemplates = {
        ...
        'T3LandFactoryBuilders',
				...
				'T2MDBaseDefenses',
				'T3MDBaseDefenses',
				'T2MDDronestationDefenses',
				'T3AntiOrbitalCannons',
				'T3DeimosArtillery',
				'ExMissileLauncher',
            },
        },
        ...
        ChallengeExpansion = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'AdvancedHeavyFactorySupport', 'LandingpadSupport', 'T1AdvancedLightBotFactoryBuilders', 'T2AdvancedHeavyFactoryBuilders','T2CyborgFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2,}}},
        ChallengeMain = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
        ...
        ChallengeNaval = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders', 'T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        NavalExpansionLarge = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        NavalExpansionSmall = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        ...
        RushExpansionAirFull = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        RushExpansionAirSmall = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        RushExpansionBalancedFull = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        RushExpansionBalancedSmall = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        RushExpansionLandFull = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 2}}},
        RushExpansionLandSmall = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 4, AdvancedHeavyFactory = 4, Landingpad = 1}}},
        RushExpansionNaval = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 0, AdvancedHeavyFactory = 0, Landingpad = 0}}},
        RushMainAir = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
        ...
        TechExpansion = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'LandingpadSupport','T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 3, AdvancedHeavyFactory = 3, Landingpad = 2}}},
        TechExpansionSmall = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpshipBuilders','T2WarpGateBuilders','T3WarpGateBuilders','AdvancedLightBotFactorySupport', 'LandingpadSupport','T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 2, AdvancedHeavyFactory = 2, Landingpad = 1}}},
        TechMain = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
        ...
        TurtleExpansion = {Builders = {'T1MDBaseDefenses','T2MDBaseDefenses','T2MDDronestationDefenses','T3MDBaseDefenses','T1WarpshipBuilders','T2WarpGateBuilders','T2WarpGateBuilders','AdvancedLightBotFactorySupport', 'LandingpadSupport','T1AdvancedLightBotFactoryBuilders','T2CyborgFactoryBuilders','T2AdvancedHeavyFactoryBuilders','T3AdvancedHeavyFactoryBuilders','T3AntiOrbitalCannons','T3DeimosArtillery','ExMissileLauncher',}, BaseSettings = {FactoryCount = {AdvancedLightBotFactory = 1, Landingpad = 1}}},
        TurtleMain = {
            Builders = {
                'AdvancedLightBotFactorySupport',
				'AdvancedHeavyFactorySupport',
